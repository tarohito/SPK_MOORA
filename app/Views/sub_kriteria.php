                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-warning fa fa-pencil-square-o" style="margin-right: 5px;" data-toggle="modal" data-target="#editModal<?= $a['id'] ?>" title="Edit">
                                                        </button>

                                                        <button type="button" href="#" data-href="<?= base_url('sub_kriteria/' . $a['id']) ?>" onclick="confirmToDelete(this)" class="btn btn-sm btn-danger fa fa-trash" title="Hapus">
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
